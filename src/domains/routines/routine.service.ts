...
export class RoutineService {
  ...
  //   console.log(
  //     "Calculating next occurrence for frequency:",
  //     frequency,
  //     "schedule:",
  //     schedule,
  //     "_timezone:",
  ...
  //     case "DAILY": {
  //       const timeParts = schedule.time?.split(":") || ["0", "0"];
  //       console.log("Time parts for DAILY:", timeParts);
  //       next = new Date(now);
  //       next.setHours(parseInt(timeParts[0]), parseInt(timeParts[1]), 0, 0);

  //       if (next <= now) {
  //         next.setDate(next.getDate() + 1);
  //         console.log("Next occurrence for DAILY is tomorrow:", next);
  //       }
  //       break;
  //     }
  //     case "WEEKLY": {
  ...
  //       console.log("Next occurrence for WEEKLY is:", next);
  //       next.setHours(parseInt(timeParts[0]), parseInt(timeParts[1]), 0, 0);
  //       break;
  //     }
  //     case "MONTHLY": {
  ...
  //         console.log("Next occurrence for MONTHLY is next month:", next);
  //       }
  //       break;
  //     }
  //     case "YEARLY": {
  ...
  //         console.log("Next occurrence for YEARLY is next year:", next);
  //       }
  //       break;
  //     }
  //     default:
